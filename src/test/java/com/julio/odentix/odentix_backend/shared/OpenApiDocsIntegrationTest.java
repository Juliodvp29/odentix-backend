...
class OpenApiDocsIntegrationTest extends AbstractIntegrationTest {
  ...
  void apiDocsRespondePublicamenteConOperaciones() throws Exception {
    mockMvc.perform(get("/v3/api-docs"))
        ...
        .andExpect(jsonPath("$.paths./api/v1/waitlist.post.responses.201").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist.post.responses.400").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist.post.responses.401").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist.post.responses.403").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist.post.responses.404").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist.get").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}.get").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/status.patch").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/convert.post").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist.get.responses.200").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist.get.responses.400").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist.get.responses.401").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist.get.responses.403").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}.get.responses.200").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}.get.responses.401").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}.get.responses.403").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}.get.responses.404").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/status.patch.responses.200").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/status.patch.responses.400").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/status.patch.responses.401").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/status.patch.responses.403").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/status.patch.responses.404").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/status.patch.responses.409").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/convert.post.responses.200").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/convert.post.responses.201").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/convert.post.responses.400").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/convert.post.responses.401").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/convert.post.responses.403").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/convert.post.responses.404").exists())
        .andExpect(jsonPath("$.paths./api/v1/waitlist/{id}/convert.post.responses.409").exists())
        .andExpect(jsonPath("$.components.schemas.WaitlistEntryResponse.properties.convertedAppointmentId").exists())
        ...
        .andExpect(jsonPath("$.paths./api/v1/invoices.get").exists())
        .andExpect(jsonPath("$.paths./api/v1/invoices/{id}.get").exists())
        ...
        // facturación SaaS con Bold (FASE11-04, FASE11-05).
        .andExpect(jsonPath("$.paths./api/v1/billing/checkout.post").exists())
        .andExpect(jsonPath("$.paths./api/v1/billing/subscription.get").exists())
        .andExpect(jsonPath("$.paths./api/v1/billing/webhooks/bold.post").exists())
        // ajustes de la clínica (pre-Fase 12).
        .andExpect(jsonPath("$.paths./api/v1/tenant/settings.get").exists())
