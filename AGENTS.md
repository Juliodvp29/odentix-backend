...
- Última verificación local: `./mvnw.cmd clean verify` el **17 de septiembre de 2026**, con **124/124 pruebas sin fallos** (incluyendo `LoginRateLimitIntegrationTest` 4/4, `PatientRoleAuthorizationIntegrationTest` 11/11, `AuthRefreshIntegrationTest` 5/5 y `JwtSecurityIntegrationTest` 7/7). Este resultado no implica verificación en CI ni despliegue a producción.
