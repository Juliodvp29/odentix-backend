...
- Última verificación local: `./mvnw.cmd clean verify` el **17 de septiembre de 2026**, con **119/119 pruebas sin fallos** (incluyendo `PatientRoleAuthorizationIntegrationTest` 11/11, `AuthRefreshIntegrationTest` 5/5 y `JwtSecurityIntegrationTest` 6/6). Este resultado no implica verificación en CI ni despliegue a producción.
